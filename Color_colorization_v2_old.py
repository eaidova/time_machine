...
def build_argparser():
    ...
    args.add_argument("-coeffs", help="Required. Path to .npy file with color coefficients.",
                         required=True, type=str)
    return parser

def color_image(input_image_path, model_path, npy_path):
    ...
    cv.imwrite('colorization-v2_old.png', colorize_image)
...
def main():
    ...
    print(args.input)
    color_image(args.input, args.model_1, args.coeffs)
